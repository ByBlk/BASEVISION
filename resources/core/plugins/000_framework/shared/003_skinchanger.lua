Components = {{
        ...
        label = "Abaissement du pic du nez",
        name = "nose_5",
        value = 0,
        min = -10,
        zoomOffset = 0.6,
        ...
        label = 'Degrade Collection',
        name = 'degrade_collection',
        value = 0,
        min = 0,
        zoomOffset = 0.4,
        camOffset = 0.65
