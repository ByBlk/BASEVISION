    ...
    if clothes ~= nil then
        for k, v in pairs(clothes) do
            if k ~= "sex" and k ~= "mom" and k ~= "dad" and k ~= "face_md_weight" and k ~= "skin_md_weight" and k ~=
                    ...
                    "chest_2" and k ~= "chest_3" and k ~= "bodyb_1" and k ~= "bodyb_2" and k ~= "bodyb_3" and k ~= "bodyb_4" and
...
AddEventHandler('skinchanger:loadSkin', function(skin, cb)
    ...
    CreateThread(function()
        if characterModel and IsModelInCdimage(characterModel) and IsModelValid(characterModel) then
            RequestModel(characterModel)
            while not HasModelLoaded(characterModel) do
                Wait(0)
            end
