    ...
    Safe = {
        ...
        Open = function(doorSide)
            ...
            elseif doorSide:lower() == "right" then
                ...
                console.debug("[bob74_ipl] Warning: " .. doorSide .. " is not a correct value. Valid values are: left right")
            end
        end,
        ...
        SetDoorState = function(doorSide, open)
            ...
            if doorHandle == 0 then
                console.debug("[bob74_ipl] Warning: " .. doorSide .. " safe door handle is 0")
                return
            end
