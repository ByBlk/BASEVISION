...
Society.newJob("hayes", {
    ...
    Sonnette = Kipstz.Jobs.Hayes.Sonnette,
    Gestion = Kipstz.Jobs.Hayes.Gestion,
    Stockage = Kipstz.Jobs.Hayes.Stockage,
    Casier = Kipstz.Jobs.Hayes.Casier,
    Catalogue = {
        Position = Kipstz.Jobs.Hayes.Catalogue,
        Items = {
            { model = "repairkit" },
            { model = "cleankit" },
    ...
    Vetement = Kipstz.Jobs.Hayes.Vetement,
    Garage = Kipstz.Jobs.Hayes.Garage,
    Craft = {
        Position = Kipstz.Jobs.Hayes.Craft,
        Items = {
